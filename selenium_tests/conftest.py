...
config.read(os.path.join(os.path.dirname(__file__),'env_config.ini'))
print(config.sections())
gecko_path = os.path.join(os.path.dirname(__file__),config.get('driver','geckodriver_path'))
IMPLICITLY_WAIT: Final[int] = 30
GECKODRIVER_PATH: Final[str] = os.path.join(gecko_path, "geckodriver")
